...
namespace QuickSort
{
    class QuickSort
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("The Quick Reverse sorted array is: \r\n");
            Array.Reverse(arr);
            ob.PrintArray(arr);
            ...
            Console.WriteLine($"Sort 1 Execution Time: {watch.ElapsedMilliseconds} ms");
            ...
            watch.Stop();
            Console.WriteLine($"Sort 2 Execution Time: {watch.ElapsedMilliseconds} ms");
